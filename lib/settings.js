...
exports.shared_pages = {
  ...
  "page_footer": {
    ...
    "powered_by_text": "<a class='nav-link poweredby' href='https://github.com/rulleren/FOS-SCC-eiquidus' target='_blank'>eIquidus Explorer v{explorer_version}</a>"
  }
};
...
// extraction_page: a collection of settings that pertain to the extraction page
exports.extraction_page = {
  // enabled: Enable/disable the extraction page (true/false)
  //          If set to false, the extraction page will be completely inaccessible
  "enabled": true,
  // show_panels: Determine whether to show the panels configured in the shared_pages.page_header section across the top of this page (true/false)
  "show_panels": false,
  // show_nethash_chart: Determine whether to show the network hashrate chart configured in the shared_pages.network_charts.nethash_chart section across the top of this page (true/false)
  ...
  // show_difficulty_chart: Determine whether to show the network difficulty chart configured in the shared_pages.network_charts.difficulty_chart section across the top of this page (true/false)
  "show_difficulty_chart": false,
  // page_header: a collection of settings that pertain to the extraction page header
  "page_header": {
    // show_img: Determine whether to show the page title image defined in the "shared_pages.page_header.page_title_image" setting (true/false)
    "show_img": true,
    // show_title: Determine whether to show the page title (true/false)
    "show_title": true,
    // show_last_updated: Determine whether to show a label below the page title with the last updated date (true/false)
    "show_last_updated": false,
    // show_description: Determine whether to show the page description (true/false)
    "show_description": true
  },
  // block_count: The number of recent blocks to include in extraction statistics
  "block_count": 1000,
  // pow_table: a collection of settings that pertain to the PoW block extraction table
  "pow_table": {
    // max_items: The maximum number of miners/minters to display in the table
    "max_items": 100
  },
  // mn_table: a collection of settings that pertain to the masternode reward distribution table
  "mn_table": {
    // max_items: The maximum number of masternodes to display in the table
    "max_items": 100
  }
};
